...
const DashboardCharts = dynamic(() => import('@/components/admin/DashboardCharts'), {
    loading: () => (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6 backdrop-blur-sm h-[380px] animate-pulse" />
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6 backdrop-blur-sm h-[380px] animate-pulse" />
        </div>
    ),
    ssr: false
        ...
        <div className="relative min-h-screen w-full bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <main className="w-full px-4 py-6">
                    ...
                    {/* Charts */}
                    <DashboardCharts promotorAnalytics={promotorAnalytics} eventoAnalytics={eventoAnalytics} />
